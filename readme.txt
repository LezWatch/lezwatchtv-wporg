...
As accurate as possible. LezWatch TV is a hobby site.
...
Because the site data is from LezWatch TV. If someone wants to make a similar site for male queers, we're happy to help them output their data so it can be used too.
